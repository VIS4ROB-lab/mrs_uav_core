...
IirFilter::IirFilter(const std::vector<double>& a_in,
                     const std::vector<double>& b_in) {
  a_ = a_in;
  b_ = b_in;

  // get the order of the filter based on the more prominent part of the
  // coefficients
...
std::vector<double> IirFilter::getBuffer() { return buffer_; }
