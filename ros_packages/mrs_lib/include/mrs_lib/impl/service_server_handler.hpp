...
ServiceServerHandler<ServiceType>::ServiceServerHandler(
    ...
    const callback_t& cbk, const rclcpp::QoS& qos)
    : ServiceServerHandler(node, address, cbk, qos,
...
ServiceServerHandler<ServiceType>::ServiceServerHandler(
    ...
    : callback_group_(callback_group),
      service_server_(node->create_service<ServiceType>(
          address, cbk, qos.get_rmw_qos_profile(), callback_group)) {}
...
ServiceServerHandler<ServiceType>::ServiceServerHandler(
    ...
    const rclcpp::CallbackGroup::SharedPtr& callback_group)
    : ServiceServerHandler(node, address, cbk, rclcpp::ServicesQoS(),
                           callback_group) {}
